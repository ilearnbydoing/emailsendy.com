<div class="relative z-30 pt-4 pb-10 bg-white dark:bg-black sm:py-16">
    <x-app.container>
        <x-marketing.elements.heading
            heading="Email Marketing Plans for Every Business"
            description="Choose the perfect plan for your email marketing needs, with scalable options from small businesses to enterprise solutions."
